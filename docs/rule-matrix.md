...
| R04 | Live/Non-live(Consist) work applies the published buffer; Non-live(Others) has none. Buffers and external work may not overlap. | `05_BUFFER_LOCATION`, R03 route footprint, project nature, occupancies | Expand buffer footprint and attach it as local evidence; do not infer cross-group simultaneity. | `closure` is observed; buffer-specific tag TBD | Consist work exposes its one-sector buffer footprint. | Role 2 | Footprint evidence fixture complete; cross-group ordering needs organiser evidence |
...
| R08 | Same location/week/co-share group is one possession and is exempt from each other's buffers; different groups are separate possessions. | occupancy rows; R04 buffer footprint | Treat a matching group as one possession and report its group/members/footprint; do not infer cross-group simultaneity. | `closure` or co-share tag TBD | Legal and illegal PM/PC/C groups retain group evidence. | Role 2 | Co-share evidence fixture complete; cross-group timing unresolved |
